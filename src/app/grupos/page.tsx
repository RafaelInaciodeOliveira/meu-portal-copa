...
// Controle do Modal: Guarda o time que o usuário clicou
  const [timeClicado, setTimeClicado] = useState<any>(null);
  
  // TRAVA O SCROLL DA TELA DE FUNDO QUANDO O MODAL ABRE
  useEffect(() => {
    if (timeClicado) {
    ...
    // Limpa a regra caso o usuário saia da página com o modal aberto
    return () => document.body.classList.remove('overflow-hidden');
  }, [timeClicado]);

  // Busca os dados APENAS do time selecionado quando o Modal abrir
      ...
      {timeClicado && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="bg-zinc-950 border border-white/10 rounded-3xl w-full max-w-2xl max-h-[85vh] flex flex-col overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200">
            ...
            {/* Corpo do Modal (Lista de Jogadores) */}
